...
public class Elf64_Ehdr extends Elf_EhdrImpl {
    public Elf64_Ehdr(BytesView view) {
        super(
                view,
                ...
                new UInt64_StructField(view, "e_entry"),
                new UInt64_StructField(view, "e_phoff"),
                new UInt64_StructField(view, "e_shoff"),
    ...
    public long e_entry() {
        return this.<UInt64_StructField>get("e_entry").simple();
    }

    public void e_entry(long value) {
        this.<UInt64_StructField>get("e_entry").simple(value);
    }

    public long e_phoff() {
        return this.<UInt64_StructField>get("e_phoff").simple();
    }

    public void e_phoff(long value) {
        this.<UInt64_StructField>get("e_phoff").simple(value);
    }

    public long e_shoff() {
        return this.<UInt64_StructField>get("e_shoff").simple();
    }

    public void e_shoff(long value) {
        this.<UInt64_StructField>get("e_shoff").simple(value);
    }
    ...
    protected Elf_Phdr createPhdr(BytesView view) {
        return new Elf64_Phdr(view);
    }

    protected Elf_Dyn createDyn(BytesView view) {
        return new Elf64_Dyn(view);
    }
}
